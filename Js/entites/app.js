class App {
    ...
    preLoadData(){
        ...
        this.#arrClient.push(new Client("Lucio","Bonelli","TortugaMaritima8",new Dog("Bolt", 1)));
        ...
        this.#arrClient.push(new Client("Rubén","Bertora","BalSan","Srconductor1",new Dog("Brian", 2)));
        ...
        this.#arrClient.push(new Client("Damian","Szifron","Zorro","Simu1ador",new Dog("Smoky", 2)));

        //preload contrataciones
        this.#arrHiring.push(new Hiring(this.#arrClient[0],""));
